  ...
  return (
    <>
      <button
        ...
        className="fixed dark:text-gray-100 bottom-6 right-6 bg-indigo-600 text-white px-4 py-3 rounded-full shadow-xl hover:scale-108 transition-all duration-300 flex items-center gap-2 z-50"
      >
      ...
      <div
        ...
        } bg-white border border-slate-300 rounded-xl shadow-xl flex flex-col overflow-hidden  z-40
        ...
        <div className="bg-slate-100 dark:bg-gray-800 px-4 py-3 flex justify-between items-center">
          ...
          <div className="flex justify-center items-center gap-2">
            <button
              ...
              className="hidden sm:block  text-slate-500 hover:text-indigo-600 hover:scale-120 transition-all duration-300"
            >
              <Maximize size={16} />
            </button>
            <HiOutlineX
              ...
              className="hover:scale-120 transition-all duration-300  text-slate-500  hover:text-indigo-600 "
            />
          </div>
